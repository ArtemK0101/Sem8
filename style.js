...
let delBtn = document.getElementById('addBtn'),
    delMsg = document.getElementById('addTitle'),
    delPrior = document.getElementById('addPrior')
    block = document.querySelector('.TODO')
...
function showItems() {
    ...
    items.forEach(function (item, index) {
        ...
        <div class='item ${ getColorForPrior(item.priority) } ${ item.checked ? 'checkedTODO' : ''}'>
            ...
            ${ index > 0 ? '<img class="item_icon" data-eid=' + index + ' src="png/arrow-up.png">' : '' } 
        </div>
        `
